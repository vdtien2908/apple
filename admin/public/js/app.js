...
$(document).ready(function () {
  var app = {
    ...
    handleScrollLoadPage: function handleScrollLoadPage() {
      var offsetFromTop = 75;
      if ($(".sidebar .menu_item.active")) {}
      var newScrollTop = $(".sidebar .menu_item.active").offset().top - offsetFromTop;
      $(".sidebar").animate({
